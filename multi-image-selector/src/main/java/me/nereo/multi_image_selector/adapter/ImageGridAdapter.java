...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(Fragment fragment, Context context, boolean showCamera, int column) {
        mFragment = (MultiImageSelectorFragment) fragment;
            ...
            if (showSelectIndicator) {
                ...
                indicator.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mFragment.selectPhotoFromCheckBox(data);
